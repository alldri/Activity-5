class GadgetsController < ApplicationController
  ...
  def decrease_stock
    ...
    @gadget.num_in_stock = @gadget.num_in_stock - 1
    @gadget.save
    redirect_to 'http://localhost:3000/gadgets'
  end
  ...
  private
    ...
    def gadget_params
      params.require(:gadget).permit(:name, :brand, :year_released, :camera, :mpixels, :internal_storage, :sim_slots, :screen_size, :os, :num_in_stock)
    end
